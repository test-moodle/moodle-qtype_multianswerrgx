...
/**
 * Testing the upgrade of multianswerrgx question attempts.
 *
...
final class upgrade_old_attempt_data_test extends \question_attempt_upgrader_test_base {
    /**
     * Tests the adaptive no-penalty behavior for multianswerrgx questions in qsession 104.
     *
     * @covers \path\to\the\method\being\tested
     */
    public function test_multianswerrgx_adaptivenopenalty_qsession104(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
            'intro' => '',
            'introformat' => '1',
            'timeopen' => '0',
            'timeclose' => '0',
        ...
        $expectedqa = (object) [
            ...
            'steps' => [
                ...
                2 => (object) [
                    ...
                    'timecreated' => 1306425739,
                    'userid' => 4,
                    'data' => ['sub1_answer' => 'frog', '-finish' => '1',
    ...
    /**
     * Tests the adaptive no-penalty behavior for multianswerrgx questions in qsession 106.
     *
     * @covers \path\to\the\method\being\tested
     */
    public function test_multianswerrgx_adaptivenopenalty_qsession106(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
        ...
        $expectedqa = (object) [
            ...
            'steps' => [
                ...
                1 => (object) [
                    ...
                    'timecreated' => 1306425757,
                    'userid' => 4,
                    'data' => ['-finish' => '1', '-_try' => '1', '-_rawfraction' => 0.0],
                ],
            ],
        ];
    ...
    /**
     * Tests the adaptive no-penalty behavior for multianswerrgx questions in qsession 108.
     *
     * @covers \path\to\the\method\being\tested
     */
    public function test_multianswerrgx_adaptivenopenalty_qsession108(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
    ...
    /**
     * Tests the adaptive no-penalty behavior for multianswerrgx questions in qsession 105.
     *
     * @covers \path\to\the\method\being\tested
     */
    public function test_multianswerrgx_adaptivenopenalty_qsession105(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
...
b) What grade would you give it? _____',
            ...
            'steps' => [
                ...
                1 => (object) [
                    'data' => ['sub1_answer' => 2, 'sub2_answer' => 'dsf',
    ...
    public function test_multianswerrgx_adaptivenopenalty_qsession107(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
...
b) What grade would you give it? _____',
    ...
    public function test_multianswerrgx_adaptivenopenalty_qsession109(): void {
        $quiz = (object) [
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswerrgx quiz',
...
b) What grade would you give it? _____',
            ...
            'steps' => [
                ...
                1 => (object) [
                    ...
                    'timecreated' => '1306425801',
                    'userid' => '3',
                    'data' => ['sub1_answer' => '3', 'sub2_answer' => 'asdgf',
                ...
                2 => (object) [
                    ...
                    'userid' => 3,
                    'data' => ['sub1_answer' => '2', 'sub2_answer' => 'asdgf',
                ...
                3 => (object) [
                    ...
                    'userid' => 3,
                    'data' => ['sub1_answer' => '2', 'sub2_answer' => 'Correct answer',
