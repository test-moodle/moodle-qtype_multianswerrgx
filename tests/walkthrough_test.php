...
/**
 * Unit tests for the multianswerrgx question type.
 *
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_numericalzero_not_answered(): void {
        ...
        // Create a multianswerrgx question with one numerical subquestion, right answer zero.
        $q = \test_question_maker::make_question('multianswerrgx', 'numericalzero');
    ...
    public function test_deferred_feedback_multiple(): void {
        ...
        // Create a multianswerrgx question.
        $q = \test_question_maker::make_question('multianswerrgx', 'multiple');
     ...
     *
     * @covers \qtype_multianswerrgx_renderer::subquestion
     */
    public function test_corrupted_question(): void {
        ...
        $question = (new qtype_multianswerrgx)->save_question($question, $fromform);
