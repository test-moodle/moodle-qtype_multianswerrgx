...
Feature: Test creating a Multianswerrgx (Cloze) question
  As a teacher
  ...
  Scenario: Create a Cloze question
    ...
    Then I should see "multianswerrgx-001" in the "categoryquestions" "table"
  ...
  Scenario: Create a broken Cloze question and correct it
    ...
    And I press "Add"
    And I set the field "Question name" to "multianswerrgx-002"
    ...
    And I press "id_submitbutton"
    And I should see "multianswerrgx-002" in the "categoryquestions" "table"
  ...
  Scenario: Try to create a Cloze question that has no answer
    ...
    And I press "Add"
    And I set the following fields to these values:
      | Question name | multianswerrgx-003                                |
