...
namespace qtype_multianswerrgx;
...
final class question_test extends \advanced_testcase {
    public function test_get_expected_data(): void {
        ...
        $this->assertEquals(['sub1_answer' => PARAM_RAW_TRIMMED,
    ...
    public function test_is_complete_response(): void {
        ...
        $this->assertTrue($question->is_complete_response(['sub1_answer' => 'Owl',
                'sub2_answer' => '2']));
        $this->assertTrue($question->is_complete_response(['sub1_answer' => '0',
                'sub2_answer' => 0]));
        $this->assertFalse($question->is_complete_response(['sub1_answer' => 'Owl']));
    }
    ...
    public function test_is_gradable_response(): void {
        ...
        $this->assertTrue($question->is_gradable_response(['sub1_answer' => 'Owl',
                'sub2_answer' => '2']));
        $this->assertTrue($question->is_gradable_response(['sub1_answer' => '0',
                'sub2_answer' => 0]));
        $this->assertTrue($question->is_gradable_response(['sub1_answer' => 'Owl']));
    }
    ...
    public function test_grading(): void {
        ...
        $this->assertEquals([0.5, question_state::$gradedpartial], $question->grade_response(
                ['sub1_answer' => 'Owl']));
        $this->assertEquals([0.5, question_state::$gradedpartial], $question->grade_response(
                ['sub1_answer' => 'Goat', 'sub2_answer' => reset($rightchoice)]));
    ...
    public function test_get_correct_response(): void {
        ...
        $this->assertEquals(['sub1_answer' => 'Owl', 'sub2_answer' => reset($rightchoice)],
    ...
    public function test_get_num_parts_right(): void {
        ...
        $response = ['sub1_answer' => 'Frog', 'sub2_answer' => $right];
        ...
        $response = ['sub1_answer' => 'Owl', 'sub2_answer' => $right];
        list($numpartsright, $numparts) = $question->get_num_parts_right($response);
        $this->assertEquals(2, $numpartsright);
        $response = ['sub1_answer' => 'Dog', 'sub2_answer' => 3];
        list($numpartsright, $numparts) = $question->get_num_parts_right($response);
        $this->assertEquals(0, $numpartsright);
        $response = ['sub1_answer' => 'Owl'];
        list($numpartsright, $numparts) = $question->get_num_parts_right($response);
        $this->assertEquals(1, $numpartsright);
        $response = ['sub1_answer' => 'Dog'];
        list($numpartsright, $numparts) = $question->get_num_parts_right($response);
        $this->assertEquals(0, $numpartsright);
        $response = ['sub2_answer' => $right];
        list($numpartsright, $numparts) = $question->get_num_parts_right($response);
        $this->assertEquals(1, $numpartsright);
    }

    public function test_get_num_parts_right_fourmc(): void {
        // Create a multianswerrgx question with four mcq.
        $question = \test_question_maker::make_question('multianswerrgx', 'fourmc');
        $question->start_attempt(new question_attempt_step(), 1);

        $response = ['sub1_answer' => '1', 'sub2_answer' => '1',
    ...
    public function test_clear_wrong_from_response(): void {
        ...
        $this->assertEquals($question->clear_wrong_from_response($response),
                ['sub1_answer' => '', 'sub2_answer' => $right]);
        $response = ['sub1_answer' => 'Owl', 'sub2_answer' => $right];
        $this->assertEquals($question->clear_wrong_from_response($response),
                ['sub1_answer' => 'Owl', 'sub2_answer' => $right]);
        $response = ['sub1_answer' => 'Dog', 'sub2_answer' => 3];
        $this->assertEquals($question->clear_wrong_from_response($response),
                ['sub1_answer' => '', 'sub2_answer' => '']);
        $response = ['sub1_answer' => 'Owl'];
        $this->assertEquals($question->clear_wrong_from_response($response),
                ['sub1_answer' => 'Owl']);
        $response = ['sub2_answer' => $right];
    ...
    public function test_compute_final_grade(): void {
        ...
        $responses = [0 => ['sub1_answer' => 'Dog', 'sub2_answer' => $wrong],
                           1 => ['sub1_answer' => 'Owl', 'sub2_answer' => $wrong],
                           2 => ['sub1_answer' => 'Owl', 'sub2_answer' => $right],
                          ];
        ...
        $responses = [0 => ['sub1_answer' => 'Dog', 'sub2_answer' => $wrong],
                           1 => ['sub1_answer' => 'Cat', 'sub2_answer' => $right],
                           2 => ['sub1_answer' => 'Owl', 'sub2_answer' => $right],
                           3 => ['sub1_answer' => 'Owl', 'sub2_answer' => $right],
                          ];
        $finalgrade = $question->compute_final_grade($responses, 1);
        ...
        $responses = [0 => ['sub1_answer' => 'Dog', 'sub2_answer' => $right],
                           1 => ['sub1_answer' => 'Dog', 'sub2_answer' => $right],
                           2 => ['sub1_answer' => 'Dog', 'sub2_answer' => $right],
                           3 => ['sub1_answer' => 'Owl', 'sub2_answer' => $right],
                          ];
        $finalgrade = $question->compute_final_grade($responses, 1);
        ...
        $responses = [0 => ['sub1_answer' => 'Dog', 'sub2_answer' => $right],
                           1 => ['sub1_answer' => 'Cat', 'sub2_answer' => $wrong],
                           2 => ['sub1_answer' => 'Frog', 'sub2_answer' => $right],
                           3 => ['sub1_answer' => 'Owl', 'sub2_answer' => $right],
                          ];
        $finalgrade = $question->compute_final_grade($responses, 1);
     ...
     *
     * @param \qtype_multianswerrgx_question $question
     * @return \qtype_multianswerrgx_question
     */
    protected function make_second_version(
            \qtype_multianswerrgx_question $question): \qtype_multianswerrgx_question {
    ...
    public function test_validate_can_regrade_with_other_version_ok(): void {
        /** @var \qtype_multianswerrgx_question $question */
        $question = \test_question_maker::make_question('multianswerrgx', 'multiple');
    ...
    public function test_zeroweight(): void {
        $this->resetAfterTest();
        /** @var \qtype_multianswerrgx_question $question */
        $question = \test_question_maker::make_question('multianswerrgx', 'zeroweight');
        $question->start_attempt(new question_attempt_step(), 1);
